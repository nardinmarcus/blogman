...
export function canonicalProductionAuthorityRootForEntry() {
...
export function createTestDeliverySink(root) {
...
export function createCanonicalProductionSinkForEntry() {
